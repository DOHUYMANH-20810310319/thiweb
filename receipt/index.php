        ...
        <div>
            ...
            <form method="post" action="create_reciept.php">
                ...
                <fieldset>
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    ...
                                    <td><input type="text" value="' . $pricetab[0] * $row["quantite"] * (1 - $promotab[0] / 100) . '" name="price[]" readonly/> VND</td>
                                </tr>
                                ';
                                }
                            ...
                            <tr>
                                ...
                                <td><input type="text" value="' . $prixLivr . '" name="price[]" readonly/> VND</td>
                            </tr>
                    ...
                    <h3>Type de livraison : <?php echo $typeLivr . '  -  ' . $prixLivr . ' VND'; ?></h3>
                </fieldset>
