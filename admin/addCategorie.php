                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="app-sidebar__heading">Thể loạil
                            <li>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Thêm danh mục
                                    <div class="page-title-subheading">Thêm danh mục con
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <h5 class="card-title">Thêm danh mục lớn</h5>
                                    <form id="addCat-form" method="post" action="redirect.php">
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="exampleEmail11" class="">Tên danh mục</label><input name="nomCat" id="exampleEmail11" placeholder="ex : PC Gamer" class="form-control"></div>
                                            </div>
                                        </div>
                                        <div class="position-relative form-group"><label for="exampleAddress" class="">Mô tả</label><input name="desCat" id="exampleAddress" placeholder="ex : original PC builds" type="text" class="form-control"></div>
                        ...
                        <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <h5 class="card-title">Thêm tiểu mục</h5>
                                    <form id="addCat-form" method="post" action="redirect.php">
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Phân loại</label>
                                            <div class="col-sm-10"><input name="nomSCat" id="exampleEmail" placeholder="ex : INTEL Build" type="text" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleSelect" class="col-sm-2 col-form-label">Nhóm</label>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2">
                                                <button type="submit" class="btn btn-primary">Thêm danh mục phụ</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
