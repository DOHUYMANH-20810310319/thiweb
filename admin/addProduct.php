            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Thêm sản phẩm
                                    <div class="page-title-subheading">Thêm sản phẩm vào web.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">Thêm sản phẩm vào csld</h5>
                            <form id="addProd-form" method="post" action="upload.php" enctype="multipart/form-data">
                                ...
                                <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Giá (VND)</label>
                                    <div class="col-sm-10"><input name="prixProd" id="exampleEmail" placeholder="ex : 3400 " type="text" class="form-control"></div>
                                </div>
                                <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Hàng dữ trữ</label>
                                ...
                                <div class="position-relative row form-group"><label for="exampleSelect" class="col-sm-2 col-form-label">Loại</label>
                                ...
                                <div class="position-relative row form-group"><label for="exampleFile" class="col-sm-2 col-form-label">Ảnh</label>
                                    <div class="col-sm-10"><input name="file" id="imageProd" type="file" accept="image/png, image/jpg, image/jpeg" class="form-control-file">
                                        <small class="form-text text-muted">Chèn hình ảnh từ tệp</small>
                                    </div>
                                </div>
